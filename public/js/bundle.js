...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFqYXQyNTAyIiwiYSI6ImNrYTVucTByZzAxd3EzZ3BlOHM3NTNpZnIifQ.SDPaKqqruSos_HGhr22sQA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/rajat2502/cka5o9wlb1an11isgk8f7xafa',
    scrollZoom: false //   center: [-118.250402, 34.04975],
    //   zoom: 10,
    //   interactive: false,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updates successfully!"));
            }
